...
| [github](./github/workflow.md) | Branches, commits, PR |

## Principe

Toute décision d'archi ou d'intégration importante doit être documentée ici avant ou juste après l'implémentation, pour garder une source de vérité partagée.
