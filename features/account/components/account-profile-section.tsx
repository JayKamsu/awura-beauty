...
export function AccountProfileSection({
  ...
  return (
    <AccountSection id="profil" title={t("account.profileTitle")}>
      <dl className="grid gap-3 sm:grid-cols-2">
        <div className={accountPanelClass}>
          <dt className="text-xs uppercase tracking-wide text-muted">
            {t("account.profileEmail")}
          </dt>
          <dd className="mt-1.5 text-sm text-foreground">{email}</dd>
        </div>
        {memberSince ? (
          <div className={accountPanelClass}>
            <dt className="text-xs uppercase tracking-wide text-muted">
              {t("account.profileSince")}
            </dt>
            <dd className="mt-1.5 text-sm text-foreground">{memberSince}</dd>
          </div>
        ) : null}
      </dl>
      ...
      <div className={`${accountPanelClass} space-y-3`}>
        <h3 className="text-sm font-medium text-primary">{t("account.pwaTitle")}</h3>
